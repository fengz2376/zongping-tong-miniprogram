var universities = [
  {
    ...
    overview: "复旦大学是教育部直属全国重点大学，位列985/211/双一流，综合实力位居全国前列。综评批次是复旦在上海招生的主渠道，每年超过90%的上海录取学生通过综评批次。2026年仍分文社组、理工组、医学组进行校测，实行'三随机'配对（专家、考生、考场随机），5名专家独立打分排序。新增数学英才班专业组，6月26-30日单独校测，重点考察数学思维与能力。同分排序：校测→高考总分→语文→数学→外语。",
    majorGroups: [
      {
      ...
      {
        group: "专业组4（数学英才班·物理+化学）", code: "04",
        majors: ["数学英才班"],
        score2025: null, score2024: null, score2023: null, score2022: null
      }
    ]
  },
  {
    ...
    overview: "上海交通大学是教育部直属全国重点大学，985/211/双一流，工科实力全国顶尖。综评批次是交大在上海招生的主渠道，每年超过90%的上海录取学生通过综评批次。2026年专业布局大升级：首次新增具身智能（拔尖英才试点班）、机器人工程（自主智能领军班/智能系统拔尖班）、电气工程及其自动化（思源试点班）、海洋智能与无人技术、生物医学工程等AI前沿方向。浦江国际学院（原密西根学院）依托张江国际理工学院全英语授课，新增机械工程、计算机、数据科学等中外合作方向。同分排序规则调整：高考→数学→外语→语文→面试。",
    majorGroups: [
      {
        group: "专业组1（不限选科）", code: "01",
      ...
      {
        group: "专业组2（物理+化学）", code: "02",
        majors: ["工科试验班类", "机械类", "电子信息类", "计算机科学与技术", "人工智能（拔尖英才试点班）", "具身智能（拔尖英才试点班）", "机器人工程（自主智能领军班）", "机器人工程（智能系统拔尖班）", "电气工程及其自动化（思源试点班）", "海洋智能与无人技术", "自动化", "船舶与海洋工程", "航空航天工程", "生物医学工程（智能医学工程试点班）"],
  ...
  },
  {
    ...
    overview: "华东师范大学是教育部直属全国重点大学，985/211/双一流，师范教育全国领先，心理学、教育学、地理学等学科实力突出。2026年继续采用AI面试+线下面试双重考核：AI面试通过微信小程序完成（仅限一次），结果作为校测参考；线下校测7月6日在普陀校区进行。特别注意：色弱、色盲及颜色识别障碍考生，化学、心理学、生物科学、地理科学、计算机、经济学等相关专业不予录取。",
    majorGroups: [
      {
        group: "专业组1（不限选科）", code: "01",
  ...
  },
  {
    ...
    overview: "华东理工大学是教育部直属全国重点大学，211/双一流，化工学科全国顶尖，材料、生物、环境等学科实力突出。2026年必选'物理+化学'专业组涵盖智能与机器人、生物医药、智慧化工、计算机、材料等方向；选考科目不限专业组涵盖经济学、工商管理、法学、外国语言文学等。",
    majorGroups: [
      {
  ...
  },
  {
    ...
    overview: "东华大学是教育部直属全国重点大学，211/双一流，纺织科学与工程全国第一，材料、设计等学科特色鲜明。综评录取学生入学后第一、第二学年各有1次全校范围内转专业资格（艺术类专业除外）。",
    majorGroups: [
      {
        group: "专业组1（物理+化学）", code: "01",
  ...
  },
  {
    ...
    overview: "上海外国语大学是教育部直属全国重点大学，211/双一流，外语教育全国顶尖，是培养外语外交人才的重要基地。2025年新增数据科学与大数据技术专业，2026年新增商务英语和外交学专业。非英语语种考生仅可报考部分专业组。",
    majorGroups: [
      {
        group: "专业组1（不限选科）", code: "01",
  ...
  },
  {
    ...
    overview: "上海大学是上海市属重点大学，211/双一流，学科门类齐全，社会学、美术学、机械工程等学科实力突出。2026年综评专业组调整为1个，取消社会学专业招生，其余要求与2025年基本一致。",
    majorGroups: [
      {
        group: "专业组1（物理+化学）", code: "01",
        majors: ["计算机科学与技术", "电子信息工程", "通信工程", "机械工程", "材料科学与工程", "自动化", "土木工程", "环境工程", "化学工程与工艺", "社会学类", "中国语言文学类", "新闻传播学类", "法学", "外国语言文学类", "经济学院", "管理学院"],
  ...
  },
  {
    ...
    overview: "浙江大学是教育部直属全国重点大学，985/211/双一流，综合实力全国前三。上海综评通过海宁国际校区招生，是上海综评中唯一的非沪高校。2026年上海综评计划仅5人，设1个专业组含2个专业（生物医学、生物信息学，中外合作办学），在海宁国际校区就读，学费16万元/学年，毕业可获浙大与英国爱丁堡大学双学位。",
    majorGroups: [
      {
        group: "专业组1（物理+化学·中外合作办学）", code: "01",
        majors: ["生物医学（中外合作办学）", "生物信息学（中外合作办学）"],
