const timeline = {
  phases: [
    ...
    },
    {
      ...
      endDate: "2026-07-02",
      description: "在高考志愿填报系统中填报综评批次志愿，可填4个平行院校专业组",
      tasks: [
        "登录志愿填报系统",
        "填报综评批次志愿（4个平行院校专业组）",
        "确认志愿信息"
      ...
      icon: "🎯",
      color: "green",
      tips: "综评批次可填报4个平行院校专业组志愿，按1:1.5投档"
    },
    {
      id: "interview",
      title: "校测面试",
      ...
      endDate: "2026-07-07",
      description: "入围考生参加高校组织的校测面试，面试满分150分。复旦数学英才班6月26-30日单独校测",
      tasks: [
        "提前熟悉面试形式和流程",
        "准备自我介绍（1-2分钟版本）",
        "模拟练习常见面试问题",
    ...
    },
    {
      ...
      endDate: "2026-07-09",
      description: "各高校公布综评批次录取结果，未录取考生正常参加后续批次",
      tasks: [
        "登录查询录取结果",
        "确认录取信息",
        "未被录取则进入本科提前批和普通批次"
